 ...
 * @private
 */
// feeds.MY_PROFILE_API_URL = 'https://www.googleapis.com/plus/v1/people/me?key={apiKey}';
feeds.MY_PROFILE_API_URL = 'https://www.googleapis.com/plus/v1/people/me';
/**
 * @type {string}
 * @const
 * @private
            ...
            success: (function (feed) {
                return function (data) {
                    ...
                    for (var i = 0; i < data.items.length; i++) {
                        ...
                        var startDate = eventEntry.start.dateTime || eventEntry.start.date;
                        var start = utils.fromIso8601(startDate);
                        var endDate = eventEntry.end.dateTime || eventEntry.end.date;
                        var end = utils.fromIso8601(endDate);
